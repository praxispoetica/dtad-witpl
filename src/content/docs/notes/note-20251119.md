---
title: PraxisPoetica I Writing and Publishing Process
date: 2025-11-19
cover:
  alt: Self-portrait of a mid-century refugee (late 1980s); photo by Victor Kane, this work licensed under CC BY-NC-SA 4.0 <https://creativecommons.org/licenses/by-nc-sa/4.0/>
...
The first in a series of notes (see [PraxisPoetica](/notes/tags/praxispoetica)) intended as a review of the writing and publishing process ever-present during the creation of the first novel in the `Denying The Amerikan Dream` series [Wandering Into The Promised Land. Who Promised What To Who, Now? Community Edition](/works/novels/dtad-witpl/dtad-witpl/) 
...
- Richard Wright, *Blueprint for Negro Writing* (you'll see a lot more of him around here later)
  - [Online text available for this article](https://genius.com/Richard-wright-author-blueprint-for-negro-writing-annotated)
...
> An amplified starter bibliography for the novel-writing process might be (with links):
...
- [Lisa Cron, Story Genius, 2016](http://wiredforstory.com/books#storygenius)
  - my recommended updated writing process system, completely compatible with the Lajos Egri process. I'm using it, since it gives us some idea of how to apply the ideas of Lajos Egri in actual practice (i.e. step-by-step, with artifacts).
- [Jennie Nash, Blueprint for a Book: Build Your Novel From the Inside Out, 2021](https://jennienash.com/fiction)
  - a vibrant writers' and writers' coach community, also in resources
  - a possible alternative to *Story Genius*
- [Leslye Penelope, Imaginary Worldbuilding: Creating Fictional Worlds for Writers](https://learn.myimaginaryfriends.net/courses/imaginary-worldbuilding). A wealth of resources. Another interesting alternative (avoid "Save the Cat" type usage within the process).
  ...
  - Significantly, Leslye Penelope also recommends Lisa Cron on her [Leslye Penelope: Resources for Writers](https://lpenelope.com/resources-for-writers/) page, a rich source for us learning writers.
- [Alice Sutlow, Developmental Editor & Book Coach of Young Adult Fiction & Beyond](https://alicesudlow.com/)
  - An editor, focusing mainly upon manuscript revision based on clear outlining of story. However in our concept of PraxisPoetica, very valuable in terms of iterative and incremental writing process right from the start. Totally compatible with Lajos Egri, including many of the terms used.
...
👉 Which is why my father changed our last name to "Kane" when my brother and I were nine years old. But I was born Victor Opas Kapelman. My father changed his last name because he was planning on emigrating to the USA with the express purpose of working for the US imperialist war machine as an aircraft design engineer, and he thought his pro Spanish Revolution stance would prevent him from getting a security clearance. Or he was ashamed of being a Jew. Or both. But I'm proud of him for his militant past and for firmly being Jewish. The author of these works has *that* surname: Kapelman. And is proud of it. See more of what I have to say on the subject of the name of the author of these works, my works, in the intro page to the [Works](/works/works) section of this site.
...
In this regard, see [Conference of Jewish Action, Davka website](https://www.davka.org/what/theleft/cja.html) (May 9-11, 1969); where at the bottom of the page it is noted by the webmaster:
